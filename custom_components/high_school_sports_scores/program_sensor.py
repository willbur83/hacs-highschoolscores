...
from custom_components.high_school_sports_scores.snapshots import ProgramResolutionStatus, ProgramSnapshot
from custom_components.high_school_sports_scores.models import Game, GameStatus
