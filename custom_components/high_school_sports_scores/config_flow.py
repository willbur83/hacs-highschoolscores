...
from custom_components.high_school_sports_scores.coordinator import school_from_entry
...
from custom_components.high_school_sports_scores.programs import SchoolYearProgram, group_school_year_programs
from custom_components.high_school_sports_scores.school_logo import validate_school_logo_override
...
from custom_components.high_school_sports_scores.selection import team_seasons_for_applicable_year
...
class HighSchoolSportsScoresConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    ) -> HighSchoolSportsScoresOptionsFlow:
        """Return the options flow handler."""
        return HighSchoolSportsScoresOptionsFlow()


class HighSchoolSportsScoresOptionsFlow(OptionsFlowWithReload):
