...
ERR_NOT_PROGRAM_SENSOR = "not_program_sensor"
ERR_NO_COORDINATOR = "no_coordinator_data"


@dataclass(frozen=True, slots=True)
class ResolvedProgramEntity:
    """Registry-owned High School Sports Scores program sensor resolution."""
...
def _send_resolution_error(
    ...
    messages = {
        ...
        ERR_NOT_PROGRAM_SENSOR: "Entity is not a High School Sports Scores program sensor",
        ERR_NO_COORDINATOR: "High School Sports Scores coordinator data is unavailable",
    }
...
async def ws_get_program_schedule(
    ...
    if program is None:
        _send_resolution_error(connection, msg, ERR_NOT_PROGRAM_SENSOR)
        return
...
def async_register_websocket_handlers(hass: HomeAssistant) -> None:
    """Register integration websocket commands once per integration."""
